  ...
  <v-container>
    <div class="d-flex justify-space-between align-center mb-6">
      <div class="d-flex align-center">
        ...
        <h2 class="text-h5 font-weight-bold">OHSHAS Dashboard</h2>
      </div>
    ...
    <v-alert type="info" dense border="left" class="mb-4">
      📌 You are working in the <strong>OHSHAS Category</strong>.  
      Upload OHSHAS-specific Excel files and generate Word documents with OHSHAS templates.
    </v-alert>

    <v-card class="pa-6 mb-6" outlined>
      <h3 class="mb-4">Upload OHSHAS File</h3>
      ...
      <h3 class="mb-2">Your OHSHAS Uploaded Files</h3>
      <v-select
        v-model="selectedFileId"
        :items="userFiles"
        item-text="file_name"
        item-value="id"
        label="Select a OHSHAS file to view data"
        outlined
        dense
        class="mb-4"
  ...
  methods: {
    ...
    async uploadFile() {
      ...
      try {
        ...
        formData.append("category", "OHSAS");
...
<template>
  <v-container>
    ...
    <div class="d-flex justify-space-between align-center mb-6">
      <div class="d-flex align-center">
        <v-icon color="primary" class="mr-2">mdi-clipboard-text-outline</v-icon>
        <h2 class="text-h5 font-weight-bold">OHSMS Dashboard</h2>
      </div>
    ...
    <!-- Info Banner -->
    <v-alert type="info" dense border="left" class="mb-4">
      📌 You are working in the <strong>OHSMS Category</strong>.  
      Upload OHSMS-specific Excel files and generate Word documents with OHSMS templates.
    </v-alert>

    <!-- Section to upload Excel/CSV file -->
    <v-card class="pa-6 mb-6" outlined>
      <h3 class="mb-4">Upload OHSMS File</h3>
      ...
      <!-- Uploaded files -->
      <!-- <h3 class="mb-2">Your OHSMS Uploaded Files</h3>
      <v-select
        v-model="selectedFileId"
        :items="userFiles"
        item-text="file_name"
        item-value="id"
        label="Select a OHSMS file to view data"
        outlined
        dense
        class="mb-4"
        @change="fetchExcelRows"
...
export default {
  ...
  methods: {
    ...
    //     const link = document.createElement("a");
    //     link.href = url;
    //     link.setAttribute("download", `${safeName}_OHSMS_checklist.docx`);
    //     document.body.appendChild(link);
    //     link.click();
